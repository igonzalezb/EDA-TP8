...
int returnCurrentPath() {
	cout << "\n";
	cout << current_path().string();//current path habla de la carpeta donde se esta ejecutando el programa.
	//current_path devuelve una variable path, y string() es un metodo que me devuelve la ruta como string
	cout << "\n";
	return 1;
}
